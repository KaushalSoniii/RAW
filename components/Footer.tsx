...
// Using existing icon components, colors will be handled by parent class or direct styling if needed.
...
const TwitterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => ( // Placeholder for X
...
const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-dark-surface border-t border-brand-dark-border text-brand-dark-text-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12">
        <div className="flex flex-col md:flex-col md:items-center justify-between items-center">
          <p className="text-sm text-center mb-4">
            &copy; {new Date().getFullYear()} RAW Bots. All rights reserved.
          </p>
          <div className="flex space-x-5 mb-4 md:mt-4">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-brand-accent transition-colors" aria-label="R&W Robotics on X/Twitter">
              <TwitterIcon className="w-5 h-5" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-brand-accent transition-colors" aria-label="R&W Robotics on GitHub">

        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-brand-dark-text-secondary leading-relaxed">
              At R&W Robotics, we are a dynamic collective of engineers, designers, and visionaries, passionately committed to redefining the frontiers of robotics and embedded systems. Our core mission is to architect intelligent, bespoke solutions that tackle complex real-world challenges and catalyze technological progress across diverse industries.
            </p>
            <p className="text-base md:text-lg text-brand-dark-text-secondary leading-relaxed">
            ...
            <p className="text-base md:text-lg text-brand-dark-text-secondary leading-relaxed">
              Built on a bedrock of innovation, unwavering integrity, and synergistic collaboration, R&W Robotics aspires to be your trusted ally in harnessing the transformative potential of automation and intelligent systems.
            </p>
          </div>
        </div>
      </div>
